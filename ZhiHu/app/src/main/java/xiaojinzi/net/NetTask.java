...
public class NetTask<Parameter> {
	...
	/* 请求完成后回调的接口 */
	public AsyncHttp.BaseDataHandler dataHandler = null;

	public AsyncHttp.ParameterHandler<Parameter> parameterDataHandler = null;
	...
	public NetTask(String url, int responseDataStyle, AsyncHttp.BaseDataHandler dataHandler, ProgressDialog pd, boolean isUseJsonCache) {
		super();
		this.url = url;
...
//	}
	...
	public NetTask(String url, int responseDataStyle, AsyncHttp.ParameterHandler<Parameter> parameterDataHandler,
