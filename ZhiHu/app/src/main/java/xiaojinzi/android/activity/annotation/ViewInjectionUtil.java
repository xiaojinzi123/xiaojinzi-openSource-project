package xiaojinzi.android.activity.annotation;
 ...
 * @author xiaojinzi
 */
public class ViewInjectionUtil implements View.OnClickListener {
    ...
    /**
     * 根据View获取事件监听类,如果有就使用获取出来的这个类,如果没有就创建一个新的
     */
//    private static Map<View, EventListener> map = new HashMap<View, EventListener>();
